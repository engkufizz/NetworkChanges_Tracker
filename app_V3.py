...
class MainWindow(QMainWindow):
    ...
    def on_clear(self):
        ...
        # Do not clear date; do not clear request number unless desired:
        # self.req_edit.clear()
        self.update_preview()
    ...
    def on_add(self):
        ...
        # Safely convert QDate to Python date (avoids relying on .toPython availability)
        ...
        # Keep request number; clear description for next input
        self.on_clear()
        self.load_table()
